 ...
 * Version			Date			Author				Remarks
 * 1.5.0			17 Mar 2022		John Kumuyi  		FSP-53 ability to select template to send Customer Invoice
 * Version			Date			Author				Remarks
 ...
 */
 ...
 function scg_invpdf_listInvoices(request, response){
     if (request.getMethod()=='GET') {
         ...
         try {
             // Get Invoice internal IDs and kick off scheduled script to process selected Invoices based on select template
             var invIds = [];
