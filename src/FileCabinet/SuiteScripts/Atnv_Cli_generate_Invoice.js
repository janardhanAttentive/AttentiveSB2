 ...
 *  1.00      21,June-2022     Janardhan S         This Script fetches the Information from the Suitelet Script(customscript_atnv_sui_generate_invoice),gets the 
 *                                                 list of sales orders based on the date Range Selected.
 *
 */
/**
 *@NApiVersion 2.x
